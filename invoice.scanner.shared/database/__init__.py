...
USAGE:
  ...
  from shared.configuration.config import get_connection, execute_sql, DB_CONFIG
  from shared.database import get_connection, execute_sql
  from shared.database.connection import get_connection, execute_sql
"""
